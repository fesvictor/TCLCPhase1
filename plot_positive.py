...
def plot_perception(filename):
    ...
    fig.suptitle("Polarity (Top 5 Daily Positive) - " + date_str, y=0.92, fontsize=25)
...
#    plt.xlabel("Name", fontsize=20)
    ...
    plt.savefig('results/polarity_output/positive/'+filename_datestamp+'_top5_positive.png', bbox_inches='tight', dpi=300)
