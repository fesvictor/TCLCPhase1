...
while(len(fb_list) >= 10):
    ...
    fb_list = fb_list[10:] 
    getResult(xxx) 
UpdateResult(['17'], 12, param['temp.mix.facebook.dir'], yearTable, 'facebook') 
...
while(len(tweet_list) >= 5):
    ...
    getResult(xxx)
UpdateResult(['17'], 12, param['temp.mix.tweet.dir'], yearTable, 'twitter')
...
while(len(others_list) >= 10):
    ...
    getResult(xxx)
UpdateResult(['17'], 12, param['temp.mix.others.dir'], yearTable , 'others')
