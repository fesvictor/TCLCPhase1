from AnalysisLib.ProcessFile import getObjectList, UpdateResult, ProcessJsonData, ProcessFbData, ProcessMalaysiaKiniData, ProcessLowyatData, ProcessTweetData, ProcessCariData
...
UpdateResult(param['temp.chinese.others.dir'], yearTable , 'others' , 'chinese')
